...
//        int nums[] = new int[]{1};
        ...
        System.out.println("最小值 = " + lc.searchMinNum(nums));
        System.out.println("最小值 = " + lc.searchMinNum2(nums));
        System.out.println("最小值 = " + lc.searchMinNum3(nums));
    }
    ...
    public int searchMinNum2(int[] nums) {
        int left = 0;
     ...
     * @return
     */
    public int searchMinNum3(int[] nums){
